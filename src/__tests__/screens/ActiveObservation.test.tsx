...
import ActiveObservations from '../../screens/ActiveObservations';
...
describe('ActiveObservations', () => {
  it('renders list of active observations and excludes completed', () => {
    ...
    const { getByText, queryByText } = render(
      <ThemeProvider theme={testTheme}>
        <ActiveObservations observations={observations} onRefresh={() => {}} refreshing={false} />
      </ThemeProvider>
    );
  ...
  it('renders empty component when no active observations', () => {
    const { getByText } = render(
       <ThemeProvider theme={testTheme}>
        <ActiveObservations observations={[]} onRefresh={() => {}} refreshing={false} />
       </ThemeProvider>
    );
